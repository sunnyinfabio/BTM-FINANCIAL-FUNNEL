    ...
    <div className="relative min-h-[calc(100vh-80px)] flex flex-col justify-center py-12 lg:py-20 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
          {/* Left Side: 55% Editorial Typography & Magnetic CTAs */}
          <motion.div
          ...
          >
            {/* Small Eyebrow: BTM FINANCIAL / SOLUTION DISCOVERY */}
            <div className="flex items-center gap-2">
              <span className="font-mono text-xs font-bold text-[#009345] uppercase tracking-[2.5px]">
                BTM FINANCIAL
              </span>
              <span className="text-slate-300 font-mono">/</span>
              <span className="font-mono text-xs font-bold text-slate-500 uppercase tracking-[2px]">
                SOLUTION DISCOVERY
              </span>
            </div>

            {/* Editorial Headline (72–88px desktop, 42–52px mobile) */}
            <div>
              <h1 className="text-4xl sm:text-6xl lg:text-[74px] xl:text-[82px] font-black tracking-tight text-[#062039] leading-[1.02] uppercase">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-[#231f20] leading-relaxed font-normal max-w-xl">
              Tell us what you're trying to solve. We'll help you discover the BTM capabilities most relevant to your business.
            </p>
            ...
            <div className="pt-2 space-y-3">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                <Button
                  ...
                  className="shadow-md font-bold text-sm sm:text-base px-8 py-4 group"
                >
              ...
              <div className="flex items-center gap-2 text-xs font-mono text-slate-500 pt-1">
                <Clock className="h-3.5 w-3.5 text-[#009345]" />
                <span>2 minutes • Personalized experience</span>
              </div>
            </div>

            {/* Bottom 01 / 05 DISCOVER Indicator */}
            <div className="pt-6 border-t border-slate-200/80 flex items-center justify-between">
              <div className="flex items-center gap-2 text-xs font-mono font-bold text-slate-600">
                <span className="text-[#009345]">01 / 05</span>
                <span className="text-slate-300">•</span>
                <span className="tracking-[2px] uppercase">DISCOVER</span>
              </div>
              <p className="text-[11px] font-mono font-semibold uppercase tracking-[2px] text-slate-400">
                Advisory • Analytics • Technology • AI
              </p>
            </div>
          </motion.div>

          {/* Right Side: 45% Abstract Financial Intelligence Visual */}
          <motion.div
