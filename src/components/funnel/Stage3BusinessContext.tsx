  ...
  return (
    <div className="min-h-[80vh] flex flex-col justify-center mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-10 sm:py-16 scroll-mt-24">
      ...
      <AnimatePresence mode="wait">
        {/* ============================================================ */}
        {/* STEP 01: "WHO ARE WE BUILDING FOR?" (Typographic Lines)      */}
        {/* ============================================================ */}
        {internalStep === 1 && (
          <motion.div
            key="step-1"
          ...
          >
            ...
            {/* Typographic Option Lines with Animated Expand */}
              ...
              {BTM_INDUSTRIES.map((industry) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      'group relative py-5 sm:py-6 flex items-center justify-between transition-all duration-300 cursor-pointer select-none',
                      isSelected || isJustClicked
                        ? 'text-[#009345] font-black pl-3'
                        : 'text-[#062039] hover:text-[#009345] hover:pl-2'
                    )}
                  >
                    {/* Left Typographic Label */}
                    <div className="flex items-center gap-4">
                      <span className="text-lg sm:text-2xl lg:text-3xl font-black uppercase tracking-tight transition-all duration-300">
                        {industry.name}
                      </span>
                    </div>
              ...
              {BTM_PRIORITIES.map((priority) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      'group relative py-4 sm:py-5 flex items-center justify-between transition-all duration-200 cursor-pointer select-none',
                      isSelected
                        ? 'text-[#062039] font-black pl-2'
                        : 'text-slate-700 hover:text-[#062039] hover:pl-2'
                    )}
                  >
              ...
              {BTM_JOURNEY_STAGES.map((stage, idx) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      'group relative py-5 sm:py-6 flex items-start sm:items-center justify-between transition-all duration-300 cursor-pointer select-none',
                      isSelected || isJustClicked
                        ? 'text-[#009345] font-black pl-3'
                        : 'text-[#062039] hover:text-[#009345] hover:pl-2'
                    )}
                  >
                    ...
                    {/* Animated Green Bottom Indicator */}
                    <div
                      className={cn(
                        'absolute bottom-0 left-0 right-0 h-[2px] transition-all duration-300',
                        isSelected || isJustClicked
